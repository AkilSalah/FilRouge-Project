            ...
            <div>
                ...
                <ul class="mt-4 flex justify-center lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2 ">
                    <li class="flex items-center hover:text-blue-500">
                        ...
                        <a href="mailto:akilsalaheddine203.com" class="text-current text-sm ml-3">
                            <strong>akilsalaheddine203.com</strong>
                        </a>
                    ...
                    <li class="flex items-center text-current hover:text-blue-500">
                        ...
                        <a href="javascript:void(0)" class="text-current text-sm ml-3">
                            <strong>+212 682 397 103</strong>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="z-10 relative h-full max-md:min-h-[350px]">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6743.723920354001!2d-9.23988831370218!3d32.31556208157724!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xdac20e11a9fcf23%3A0x923008223b846a6c!2sMiftah%20Khier%2C%20Safi!5e0!3m2!1sfr!2sma!4v1714569177971!5m2!1sfr!2sma" class="left-0 top-0 h-full w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" frameborder="0"
